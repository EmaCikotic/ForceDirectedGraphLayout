...
public class DistributedGraphPanel extends JPanel {
        ...
        public DistributedGraphPanel(Graph graph, LayoutAlgorithm layout, double durationMs, double averageIterationsMS, Mode mode) {
            this.graph = graph;
            this.layout = layout;
